                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            showMessage("Регистрация не удалась" + task.getException().getMessage());
                            buttonRegister.setVisibility(View.VISIBLE);
                            progressRegister.setVisibility(View.INVISIBLE);
                                ...
                                .addOnCompleteListener(new OnCompleteListener<Void>() {
                                    ...
                                    public void onComplete(@NonNull Task<Void> task) {
                                        ...
                                        if (task.isSuccessful()) {
                                            ...
                                            showMessage("Регистрация пройдена!");
                                            updateUI();
                                        }
    ...
    private void checkAndRequestForPermission() {
        ...
        if (ContextCompat.checkSelfPermission(RegisterActivity.this, Manifest.permission.READ_EXTERNAL_STORAGE)
            ...
            if (ActivityCompat.shouldShowRequestPermissionRationale(RegisterActivity.this, Manifest.permission.READ_EXTERNAL_STORAGE)) {
                ...
                Toast.makeText(RegisterActivity.this,"Нвозможно выполнить без соглашения!",Toast.LENGTH_SHORT).show();

 ...
 * {@link RotundaFragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link RotundaFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class RotundaFragment extends Fragment {
    ...
    private RotundaFragment.OnFragmentInteractionListener mListener;
    private FloatingActionButton fab;
    private MediaPlayer sound;

    public RotundaFragment() {
     ...
     * @return A new instance of fragment RotundaFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static RotundaFragment newInstance(String param1, String param2) {
        RotundaFragment fragment = new RotundaFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View fragmentView = inflater.inflate(R.layout.fragment_rotunda, container, false);

        sound = MediaPlayer.create(getActivity(), R.raw.rotunda_voice);
